...
class TestNakedTwins(unittest.TestCase):
    ...
    def test_naked_twins_missed(self):
        solution.display(self.naked_twins_missed_testing)
        print('naked_twins()-----------------------------------------')
        solution.display(solution.naked_twins(self.naked_twins_missed_testing))
